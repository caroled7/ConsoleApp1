...
namespace Assignment_2
{
  public class StockList
  {
    ...
    {
      -- stock.holdings
            compare example -- use Compare to -- look at addfirst logic
    ...
    public StockList MergeList(StockList listToMerge) -- Carole
    {

    -- stock.holdings
            compare example -- use Compare to -- look at addfirst logic, add last
            // write your implementation here
